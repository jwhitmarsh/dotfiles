...
# brew
alias bo="brew outdated -v | grep -v pinned"
...
alias chrome-headless="/Applications/Google\ Chrome.app/Contents/MacOS/Google\ Chrome --headless --disable-gpu --remote-debugging-port=9222 https://www.google.co.uk"